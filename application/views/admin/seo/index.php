            ...
            <nav class="col-md-2 d-md-block bg-dark sidebar">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="<?= base_url('admin/logs') ?>"><i class="fas fa-history"></i> Audit Log</a></li>
                        <li class="nav-item"><a class="nav-link text-white active" href="<?= base_url('admin/seo') ?>"><i class="fas fa-search"></i> SEO</a></li>
                    </ul>
                </div>
            </nav>
